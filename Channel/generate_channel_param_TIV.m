...
% =========================================================================
% -- Function to generate the required time-invariant THz channel parameters
% =========================================================================
...
p.Nsub_b = 2^9;                  % Number of sub-bands in each subcarrier
...
if (p.Fc + p.BW/2) < 0.55e12
    ...
    p.clusterDecayFactor = 3.12*1e-9;       % Cluster decay factor (nsec)
    p.rayDecayFactor = 0.91*1e-9;           % Ray decay factor (nsec)
...
if(strcmp(p.Misalignment, 'On'))
    ...
    p.h_ma = 1; % No misalignment coefficient, default as 1.
end
