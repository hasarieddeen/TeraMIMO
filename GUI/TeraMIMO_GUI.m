...
% Last Modified by GUIDE v2.5 23-Apr-2021 19:50:13
...
if p.tv_tiv_channel
    ...
    p.Nsubb = str2double(get(handles.subc_edit,'String'));
    if ~CheckPowerofTwo(p.Nsubb)
      error('Number of subcarriers should be power of 2');  
    end
    
    p.Nsubc = str2double(get(handles.subb_edit,'String'));
    if ~CheckPowerofTwo(p.Nsubc)
